...
--
-- Host: 127.0.0.1
-- Generation Time: May 21, 2025 at 03:01 PM
...
--
-- Database: `tugasmodul7_dbms_2420506031`
--
...
('P001', 'Laptop', 7000000),
('P002', 'Mouse', 1500000),
('P003', 'Headset', 2500000),
('P004', 'Mouse Pad', 900000),
('P005', 'Speaker', 1500000);
...
ALTER TABLE `transaksi`
  ...
  ADD KEY `id_total_harga` (`total_harga`);
